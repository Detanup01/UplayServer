namespace ClientKit.Demux
{
    public class Debug
    {
        ...
        public static void WriteDebug(string strLog, string logname = "dmx_debug.txt")
        {
            if (isDebug == true)
            {
        ...
        public static void WriteBytes(byte[] bytes, string logname = "dmx_debug.txt")
        {
            if (isDebug == true)
            {
        ...
        public static void WriteText(string text, string logname = "dmx_debug.txt")
        {
            if (isDebug == true)
            {
