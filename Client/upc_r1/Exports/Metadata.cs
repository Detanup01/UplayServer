...
internal class Metadata
{
    ...
    {
        Basics.Log(nameof(UPLAY_METADATA_ClearContinuousTag), [aStringNameUtf8]);
        return true;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_METADATA_SetContinuousTag), [aStringNameUtf8, aStringValueUtf8]);
        return true;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_METADATA_SetSingleEventTag), [aStringNameUtf8, aStringValueUtf8]);
        return true;
    }
}
