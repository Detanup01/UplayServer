...
internal class Avatar
{
    ...
    {
        Basics.Log(nameof(UPLAY_AVATAR_GetBitmap), [aAvatarId, aAvatarSize, aOutRGBA, aOverlapped]);
        return true;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_AVATAR_GetAvatarIdForCurrentUser), [aOutAvatarId, aOverlapped]);
        return true;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_AVATAR_Get), [aAccountIdUtf8, aAvatarSize, aOutRGBA, aOverlapped]);
        return true;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_AVATAR_Release), [aRGBA]);
        return false;
    }
}
