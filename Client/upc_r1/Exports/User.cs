...
internal class User
{
    ...
    {
        Basics.Log(nameof(UPLAY_USER_ClearGameSession), []);
        return true;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_ConsumeItem), [aTransactionIdUtf8, aUplayId, aQuantity, aSignatureUtf8, aOverlapped, aOutResult]);
        return true;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetAccountIdUtf8), []);
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetCPUScore), [aOutCpuScore]);
        return false;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetCdKeyUtf8), [aUplayId]);
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetCdKeys), [aOutCdKeyList, aOverlapped]);
        return false;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetConsumableItems), [aOutConsumableItemsList]);
        return false;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetCredentials), [aOutUserCredentials, aOverlapped]);
        return false;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetEmail), [aOutEmail]);
        return 0;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetEmailUtf8), []);
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetGPUScore), [aOutGpuScore]);
        return false;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetGPUScoreConfidenceLevel), [aOutConfidenceLevel]);
        return false;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetNameUtf8), []);
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetPassword), [aOutPassword]);
        return 0;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetPasswordUtf8), []);
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetProfile), [aAccountIdUtf8, aOverlapped, aOutProfile]);
        return false;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetTicketUtf8), []);
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetUsername), [aOutUsername]);
        return 0;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_GetUsernameUtf8), []);
        return Marshal.StringToHGlobalAnsi(UPC_Json.GetRoot().Account.Name);
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_IsConnected), []);
        return true;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_IsInOfflineMode), []);
    ...
    {
        Basics.Log(nameof(UPLAY_USER_IsOwned), [aUplayId]);
        return true;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_ReleaseCdKeyList), [aCdKeyList]);
        return true;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_ReleaseConsumeItemResult), [aConsumeItemResult]);
        return true;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_ReleaseProfile), [aOutProfile]);
        return true;
    }
    ...
    {
        Basics.Log(nameof(UPLAY_USER_SetGameSession), [aGameSessionIdentifier, aSessionData, aFlags]);
        return false;
    }
}
