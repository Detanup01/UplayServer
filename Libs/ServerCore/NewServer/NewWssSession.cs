...
public class NewWssSession : NewHttpsSession, IWebSocket
{
    /// <summary>
    /// Checks if the Session is WSS Based
    /// </summary>
    public bool IsWSSConnection { get; protected set; }
    internal readonly WebSocket WebSocket;
    public NewWssSession(NewServer server) : base(server)
    {
    ...
    public NetCoreServer.Buffer ReceiveBinary()
    {
        NetCoreServer.Buffer result = new();
