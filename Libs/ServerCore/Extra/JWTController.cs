...
public class JWTController
{
    ...
    public static string CreateOwnershipToken(Guid UserId, uint uplayId, uint ProdId, uint branchId, List<AppFlags> flags, long exp = long.MinValue)
    {
        RSA rsa = RSA.Create();
    ...
    public static string CreateUplayTicket(Guid UserId, uint uplayId, int platform, long exp = long.MinValue)
    {
        RSA rsa = RSA.Create();
        rsa.FromXmlString(File.ReadAllText("cert/private.xml"));
        File.WriteAllText("cert/private.xml", rsa.ToXmlString(true));
    ...
    public static string CreateAuthToken(Guid UserId, Guid SessionId, Guid AppId, string env = "prod", long exp = long.MinValue)
    {
        RSA rsa = RSA.Create();
        rsa.FromXmlString(File.ReadAllText("cert/private.xml"));
        File.WriteAllText("cert/private.xml", rsa.ToXmlString(true));
