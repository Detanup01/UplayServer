...
public class Download
{
    ...
    public class ReqRSP
    {
        ...
        public static void Initialize(Guid ClientNumb, InitializeReq initialize)
        {
            ...
            {
                TokenValid = JWTController.Validate(initialize.OwnershipToken);
            ...
            else
            {
                ...
                if (ServerConfig.Instance.Demux.GlobalOwnerShipCheck || (initialize.Signature != null && Ownership.GetOwnerSignature(userID).ToBase64() != "T3duZXJTaWduYXR1cmVfSXNGYWlsZWQ="))
                {
