...
internal class Friends
{
    ...
    {
        Log(nameof(UPC_FriendAdd), [inContext, inSearchStringUtf8, inOptCallback, inOptCallbackData]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_FriendRemove), [inContext, inUserIdUtf8, inOptCallback, inOptCallbackData]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_FriendCheck), [inContext, inUserIdUtf8]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_FriendCheck_Extended), [inContext, inUserIdUtf8]);
    ...
    {
        Log(nameof(UPC_FriendListFree), [inContext, inUserIdUtf8]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_FriendListGet), [inContext, inOptOnlineStatusFilter, outFriendList, inCallback, inOptCallbackData]);
