...
internal class Overlay
{
    ...
    {
        Log(nameof(UPC_ShowBrowserUrl), [inContext, inBrowserUrlUtf8]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_OverlayBrowserUrlShow), [inContext, inBrowserUrlUtf8, inOptCallback, inOptCallbackData]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_OverlayFriendInvitationShow), [inContext, inOptIdListUtf8, inOptIdListLength]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_OverlayFriendInvitationShow_Extended), [inContext, inOptIdListUtf8, inOptIdListLength, unk1, unk2]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_OverlayFriendSelectionFree), [inContext, inSelectedFriends]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_OverlayFriendSelectionShow), [inContext, inIdListUtf8, inIdListLength, outSelectedFriends, inCallback, inCallbackData]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_OverlayMicroAppShow), [inContext, inOptMicroAppParamList, inOptCallback, inOptCallbackData]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_OverlayNotificationShow), [inContext, inId]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_OverlayNotificationShow_Extended), [inContext, inId, unk1, unk2]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_OverlayShow), [inContext, inSection, inOptCallback, inOptCallbackData]);
        return 0;
    }
}
