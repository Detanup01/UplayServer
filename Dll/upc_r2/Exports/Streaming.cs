...
internal class Streaming
{
    ...
    {
        Log(nameof(UPC_StreamingCurrentUserCountryFree), [inContext, intUtf8Country]);
        return -4;
    }
    ...
    {
        Log(nameof(UPC_StreamingCurrentUserCountryGet), [inContext, outUtf8Country, callback, callbackData]);
        return -4;
    }
    ...
    {
        Log(nameof(UPC_StreamingDeviceTypeGet), [inContext, outType, callback, callbackData]);
        return -4;
    }
    ...
    {
        Log(nameof(UPC_StreamingInputGamepadTypeGet), [inContext, outType, callback, callbackData]);
        return -4;
    }
    ...
    {
        Log(nameof(UPC_StreamingInputTypeGet), [inContext, outType, callback, callbackData]);
        return -4;
    }
    ...
    {
        Log(nameof(UPC_StreamingNetworkDelayForInputGet), [inContext, outdelayMs, callback, callbackData]);
        return -4;
    }
    ...
    {
        Log(nameof(UPC_StreamingNetworkDelayForVideoGet), [inContext, outdelayMs, callback, callbackData]);
        return -4;
    }
    ...
    {
        Log(nameof(UPC_StreamingNetworkDelayRoundtripGet), [inContext, outdelayMs, callback, callbackData]);
        return -4;
    }
    ...
    {
        Log(nameof(UPC_StreamingResolutionGet), [inContext, outResolution, callback, callbackData]);
        return -4;
    }
    ...
    {
        Log(nameof(UPC_StreamingResolutionFree), [inContext, inResolution]);
        return -4;
    }
    ...
    {
        Log(nameof(UPC_StreamingTypeGet), [inContext, outType]);
