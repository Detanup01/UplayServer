...
internal class Multiplayer
{
    ...
    {
        Log(nameof(UPC_MultiplayerInvite), [inContext, inUserIdUtf8, inOptCallback, inOptCallbackData]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_MultiplayerInviteAnswer), [inContext, inSenderIdUtf8, inIsAccepted, inOptCallback, inOptCallbackData]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_MultiplayerSessionClear), [inContext]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_MultiplayerSessionClear_Extended), [inContext, unk1, unk2]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_MultiplayerSessionFree), [inContext, inMultiplayerSession]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_MultiplayerSessionSet), [inContext, inContext, inMultiplayerSession]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_MultiplayerSessionGet), [inContext, outMultiplayerSession]);
        return 0;
    }
    ...
    {
        Log(nameof(UPC_MultiplayerSessionSet_Extended), [inContext, inMultiplayerSession, unk1, unk2]);
        return 0;
    }
}
