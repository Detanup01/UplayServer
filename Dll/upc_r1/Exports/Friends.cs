...
public class Friends
{
    ...
    {
        Log(nameof(UPLAY_FRIENDS_AddPlayedWith), [aDescriptionUtf8, aDescriptionUtf8, aAccountIdListLength]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_FRIENDS_AddToBlackList), [aAccountIdUtf8, aOverlapped]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_FRIENDS_DisableFriendMenuItem), [aId]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_FRIENDS_EnableFriendMenuItem), [aId, aMenuItemMode, aFilter]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_FRIENDS_GetFriendList), [aFriendListFilter, aOutFriendList]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_FRIENDS_Init), [aFlags]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_FRIENDS_InviteToGame), [aAccountIdUtf8, aOverlapped]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_FRIENDS_IsBlackListed), [aAccountIdUtf8]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_FRIENDS_IsFriend), [aAccountIdUtf8]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_FRIENDS_RemoveFriendship), [aAccountIdUtf8, aOverlapped]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_FRIENDS_RemoveFromBlackList), [aAccountIdUtf8, aOverlapped]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_FRIENDS_RequestFriendship), [aSearchStringUtf8, aOverlapped]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_FRIENDS_RespondToGameInvite), [aInvitationId, aAccept]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_FRIENDS_ShowFriendSelectionUI), [aAccountIdFilterListUTF8, aAccountIdFilterListLength, aOverlapped, aOutResult]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_FRIENDS_ShowInviteFriendsToGameUI), [aAccountIdFilterListUtf8, aAccountIdFilterListLength]);
        return false;
    }
}
