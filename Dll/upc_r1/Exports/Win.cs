...
internal class Win
{
    ...
    {
        Log(nameof(UPLAY_WIN_GetActions), [aOutActionList, aOverlapped]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_WIN_GetRewards), [aOutRewardList, aOverlapped]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_WIN_GetUnitBalance), [aOutBalance, aOverlapped]);
        return false;
    }
    ...
    {
        Log(nameof(UPLAY_WIN_RefreshActions), []);
        return true;
    }
    ...
    {
        Log(nameof(UPLAY_WIN_ReleaseActionList), [aActionList]);
        return true;
    }
    ...
    {
        Log(nameof(UPLAY_WIN_ReleaseRewardList), [aRewardList]);
        return true;
    }
    ...
    {
        Log(nameof(UPLAY_WIN_SetActionsCompleted), [aActionIdsUtf8, aActionIdsCount, aOverlapped]);
        return true;
    }
}
